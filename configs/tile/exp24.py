...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/home/user/dataset/2021tianchi/tile_round2_train_20210208/train_1k.json',
        #'/home/user/dataset/2021tianchi/tile_round2_train_20210208/train--toy.json',
        img_prefix=
        '/home/user/dataset/2021tianchi/tile_round2_train_20210208/train_imgs_1k',
        pipeline=[
            ...
            dict(
                ...
                action_prob=(1, 0, 0),
                #scale=(0.05, 0.1),  # clw note: debug use
                scale=(1.0, 1.2),
                dx=15,
                #dx=1,
                dy=15,
                ...
                color_prob=0.5,
                hflag=False,
                aug_ratio=0.5),  # clw note: 1.0结果很差
