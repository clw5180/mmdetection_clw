model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
		#norm_eval=False, # clw note: origin training use syncBN
        style='pytorch'),
    neck=dict(
        type='FPN',
...
load_from = '/home/user/.cache/torch/mmdetection/faster_rcnn_s50_fpn_syncbn-backbone+head_mstrain-range_1x_coco_20200926_125502-20289c16.pth'
