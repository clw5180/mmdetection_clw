...
data = dict(
    ...
    train=dict(
        type='TileDataset',
        ann_file=
        '/home/user/dataset/2021tianchi/tile_round2_train_20210204/train.json',
        img_prefix=
        '/home/user/dataset/2021tianchi/tile_round2_train_20210204/train_imgs',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            #dict(type='Concat', template_path='/home/user/dataset/2021tianchi/tile_round2_train_20210204/train_template_imgs'),
            dict(type='Concat6', template_path='/home/user/dataset/2021tianchi/tile_round2_train_20210204/train_template_imgs'),
    ...
    val=dict(
        type='TileDataset',
        ann_file='/home/user/dataset/2021tianchi/tile_round2_train_20210204/val.json',
        img_prefix='/home/user/dataset/2021tianchi/tile_round2_train_20210204/train_imgs',
        pipeline=[
            dict(type='LoadImageFromFile'),
            #dict(type='Concat', template_path='/home/user/dataset/2021tianchi/tile_round2_train_20210204/train_template_imgs'),
            dict(type='Concat6', template_path='/home/user/dataset/2021tianchi/tile_round2_train_20210204/train_template_imgs'),
