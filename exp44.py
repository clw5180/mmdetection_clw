...
data = dict(
    ...
    val=dict(
        type='TileDataset',
        ann_file=
        '/home/user/dataset/2021tianchi/tile_round2_train_20210208/val.json',
        img_prefix=
        '/home/user/dataset/2021tianchi/tile_round2_train_20210208/train_imgs',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    test=dict(
        ...
        pipeline=[
            ...
            dict(
                type='MultiScaleFlipAug',
                #img_scale=(1536, 1536),
                #img_scale=[(4096, 1800), (4096, 1668), (4096, 1536)],
                img_scale=[(4096, 1800), (4096, 1536)],
                flip=True,
                transforms=[
                    dict(type='Resize', keep_ratio=True),
                    dict(type='RandomFlip'),
...
log_level = 'INFO'
load_from = '/home/user/.cache/torch/mmdetection/htc_r50_fpn_20e_coco_20200319-fe28c577_carafe.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/exp44'
gpu_ids = range(0, 1)
